...
# #         # Validate superclass index before proceeding
...
# #         # Apply filtering if superclass_idx is set (e.g., 16)
# #         if hasattr(self, 'superclass_idx') and self.superclass_idx is not None:
# #             print(f"Filtering dataset for superclass {self.superclass_idx}")
# #             self.train_dataset = self._filter_superclass(train_dataset)
# #             self.test_dataset = self._filter_superclass(test_dataset)
        
# #         # Save the filtered dataset
# #         os.makedirs("datasets/saved_data_files", exist_ok=True)
# #         torch.save(self.get_train_dataset, self.train_data_path)
# #         torch.save(self.get_test_dataset, self.test_data_path)
# #         print("Saved transformed dataset to disk.")
...
# #         # Get the list of fine labels in this superclass (e.g., [36,50,65,74,80])
# #         fine_labels = CIFAR100_SUPERCLASS_LABELS[self.superclass_idx]
# #         # Create a mapping from original label to 0-based index
...
# #             mapped_label = label_map[original_label]  # Convert to 0-4
...
# #         if self.dataset_name == "cifar100" or self.dataset_name.startswith("cifar100_subset"):
